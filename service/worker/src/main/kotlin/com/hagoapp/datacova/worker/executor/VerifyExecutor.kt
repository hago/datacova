...
import com.hagoapp.datacova.lib.verification.TaskActionVerify
    ...
    override fun execute(taskExecution: TaskExecution, action: TaskAction, data: DataTable<out ColumnDefinition>) {
        ...
        validators.forEachIndexed { i, it ->
            try {
                ...
                logger.error(
                    "closing validator of type {} causes error: {}", action.configurations[i].ruleConfig.configType, e.message
                )
            }
        }
    }
